...
const RegisterCitizen = () => {
    ...
    const { login } = useAuth(); // We might automatically log them in or ask them to login. Let's redirect to login for simplicity.
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post('http://localhost:8000/api/auth/register/citizen', {
                name,
                email,
                password,
                role: "citizen"
        ...
        <div className="flex min-h-[calc(100vh-4rem)] w-full">
            ...
            <div className="hidden flex-1 lg:flex relative bg-[#111827] overflow-hidden items-center justify-center">
                <div
                    ...
                    style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1541888059040-394ffac618db?q=80&w=2000&auto=format&fit=crop")' }}
                ></div>
                ...
                <div className="relative z-10 p-12 max-w-lg text-left">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-md mb-8">
                        ...
                        <span className="text-sm font-semibold tracking-wider text-amber-300 uppercase">Citizen Portal</span>
                    </div>
                    <h1 className="text-5xl font-black tracking-tight text-white mb-6 leading-tight">
                        Empower your <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-400">Neighborhood</span>
                    </h1>
                    <p className="text-xl text-[#cbd5e1] mb-8 leading-relaxed font-medium">
                        Join thousands of active citizens tracking local hazards, holding authorities accountable, and driving real change.
                    </p>
                </div>
            </div>
                ...
                <div className="mx-auto w-full max-w-sm relative z-10">
                    <div className="text-center lg:text-left mb-10">
                        ...
                        <p className="text-sm text-[#94a3b8] font-medium">
                            ...
                            <Link to="/login" className="font-bold text-[#0d9488] hover:text-[#0f766e] transition-colors">
                                Sign in here
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="mt-8">
                        <div className="bg-[#1e293b] py-8 px-6 shadow-xl border border-[#334155] rounded-2xl sm:px-10">
                            <form className="space-y-6" onSubmit={handleSubmit}>
                                <div>
                                    <label htmlFor="name" className="block text-sm font-bold text-[#cbd5e1] mb-2">
                                        Full Name
                                    </label>
